...
export const RESUMES: Resume[] = [
  ...
  },
  {
    id: 2,
    name: 'João Neto',
    photoUrl: 'https://media.licdn.com/dms/image/C4D03AQHy9CdXNDtWpA/profile-displayphoto-shrink_200_200/0/1661897989347?e=1677715200&v=beta&t=gyA4TXOwJrckR4z_D6hBdAzRY9_8BjMqIIjm-ECSDzQ',
    role: 'Desenvolvedor',
    about:
      'Desenvolvedor | Programador | Full Stack | Python | Javascript | Git | MongoDB | NodeJS | Análise e Desenvolvimento de Sistemas',
    contacts: [
      {
        icon: 'whatsapp',
        title: 'Whatsapp',
